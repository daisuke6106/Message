...
public class AbstractMessageExceptionTest extends TestCaseTemplate {

	@Test
	public void constractor() {
		DummyAbstractMessageException dummyAbstractMessageException1 = new DummyAbstractMessageException(DummyMessage.M0001);
		assertEquals(dummyAbstractMessageException1.getMessageObj(), DummyMessage.M0001);
		...
		DummyAbstractMessageException dummyAbstractMessageException2 = new DummyAbstractMessageException(DummyMessage.M0001, "test");
		assertEquals(dummyAbstractMessageException2.getMessageObj(), DummyMessage.M0001);
		...
		DummyAbstractMessageException dummyAbstractMessageException3 = new DummyAbstractMessageException(DummyMessage.M0002, strs);
		assertEquals(dummyAbstractMessageException3.getMessageObj(), DummyMessage.M0002);
		...
		strList.add("test2");
		strList.add("test3");
		DummyAbstractMessageException dummyAbstractMessageException4 = new DummyAbstractMessageException(DummyMessage.M0003, strList);
		assertEquals(dummyAbstractMessageException4.getMessageObj(), DummyMessage.M0003);
	...
	public void constractorWithThrowable() {
		...
		DummyAbstractMessageException dummyAbstractMessageException1 = new DummyAbstractMessageException(DummyMessage.M0001, sampleException);
		assertEquals(dummyAbstractMessageException1.getMessageObj(), DummyMessage.M0001);
		assertEquals(dummyAbstractMessageException1.getMessage(), "デフォルトのテストメッセージ{0}");
		assertEquals(dummyAbstractMessageException1.getEmbeddedStrList().size(), 0);
		...
		DummyAbstractMessageException dummyAbstractMessageException2 = new DummyAbstractMessageException(DummyMessage.M0001, "test", sampleException);
		assertEquals(dummyAbstractMessageException2.getMessageObj(), DummyMessage.M0001);
		assertEquals(dummyAbstractMessageException2.getMessage(), "デフォルトのテストメッセージtest");
		assertEquals(dummyAbstractMessageException2.getEmbeddedStrList().size(), 1);
		...
		String[] strs = {"test1", "test2"};
		DummyAbstractMessageException dummyAbstractMessageException3 = new DummyAbstractMessageException(DummyMessage.M0002, strs, sampleException);
		assertEquals(dummyAbstractMessageException3.getMessageObj(), DummyMessage.M0002);
		assertEquals(dummyAbstractMessageException3.getMessage(), "デフォルトのテストメッセージtest1,test2");
		assertEquals(dummyAbstractMessageException3.getEmbeddedStrList().size(), 2);
		...
		strList.add("test2");
		strList.add("test3");
		DummyAbstractMessageException dummyAbstractMessageException4 = new DummyAbstractMessageException(DummyMessage.M0003, strList, sampleException);
		assertEquals(dummyAbstractMessageException4.getMessageObj(), DummyMessage.M0003);
		assertEquals(dummyAbstractMessageException4.getMessage(), "デフォルトのテストメッセージtest1,test2,test3");
		assertEquals(dummyAbstractMessageException4.getEmbeddedStrList().size(), 3);
...
class DummyAbstractMessageException extends AbstractMessageException {
	...
	private static final long serialVersionUID = -7819467041894651115L;
